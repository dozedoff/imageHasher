...
static void create_services(AvahiClient *c) {
    ...
    if (avahi_entry_group_is_empty(group)) {
        ...
        if ((ret = avahi_entry_group_add_service(group, AVAHI_IF_UNSPEC, AVAHI_PROTO_UNSPEC, AVAHI_PUBLISH_UPDATE, name, "_ipp._tcp", NULL, NULL, 5555, "test=blah", r, NULL)) < 0) {
        ...
        if ((ret = avahi_entry_group_add_service(group, AVAHI_IF_UNSPEC, AVAHI_PROTO_UNSPEC, AVAHI_PUBLISH_UPDATE, name, "_printer._tcp", NULL, NULL, 4444, NULL)) < 0) {
...
//        if ((ret = avahi_entry_group_add_service_subtype(group, AVAHI_IF_UNSPEC, AVAHI_PROTO_UNSPEC, AVAHI_PUBLISH_UPDATE, name, "_printer._tcp", NULL, "_magic._sub._printer._tcp") < 0)) {
