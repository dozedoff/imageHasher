...
#ifndef IMAGE_RECORD_ODB_HXX
#define IMAGE_RECORD_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::imageHasher::db::table::ImageRecord >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::imageHasher::db::table::ImageRecord >
  {
    public:
    typedef ::imageHasher::db::table::ImageRecord object_type;
    typedef ::imageHasher::db::table::ImageRecord* pointer_type;
...
namespace odb
{
  ...
  class access::object_traits_impl< ::imageHasher::db::table::ImageRecord, id_sqlite >:
    public access::object_traits< ::imageHasher::db::table::ImageRecord >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::imageHasher::db::table::ImageRecord, id_common >:
    public access::object_traits_impl< ::imageHasher::db::table::ImageRecord, id_sqlite >
  {
  };
